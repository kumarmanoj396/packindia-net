...
export default function ProductsExplorer() {
  ...
  return (
    <>
      ...
      <style jsx>{`
        .products-explorer{display:grid;grid-template-columns:220px 1fr;gap:24px;align-items:start;margin-top:8px}
        .product-sidebar{border:1px solid #e4e9ed;background:#fff;box-shadow:0 6px 20px rgba(10,40,70,.05)}
        ...
        @media(max-width:900px){.products-explorer{grid-template-columns:180px 1fr}.products-grid-inner{grid-template-columns:repeat(2,1fr)!important}}
