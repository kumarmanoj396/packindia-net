  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .products-grid-inner{grid-template-columns:repeat(3,1fr)!important;gap:14px!important}.products-grid-inner .product-art{height:195px;padding:12px;box-sizing:border-box}.products-grid-inner .product-image{width:100%;height:100%;margin:0;object-fit:contain}.products-grid-inner .product-card-body{padding:18px 15px 15px;border-top:8px solid var(--surface-soft)}
