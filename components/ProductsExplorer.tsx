...
function ProductsExplorerContent() {
  ...
  useEffect(() => {
    setActive(requestedCategory && categories.includes(requestedCategory) ? requestedCategory : "All Products");
  }, [requestedCategory]);
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .products-grid-inner{grid-template-columns:repeat(3,1fr)!important;gap:14px!important}
...
export default function ProductsExplorer() {
  return <Suspense fallback={null}><ProductsExplorerContent /></Suspense>;
}
