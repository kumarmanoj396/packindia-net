...
export default function Contact(){
  ...
  return <main>
    ...
    <ContactCta/>
    <style jsx>{` .contact-enhanced{align-items:start}.contact-left{padding:8px 0}.contact-left h2{font-size:32px;color:var(--heading);margin:8px 0 12px}.contact-intro{color:var(--muted);font-size:13px;line-height:1.8;max-width:470px}.contact-info{margin-top:26px}.whatsapp-contact{display:inline-flex;align-items:center;gap:8px;margin-top:25px;background:#148f55;color:#fff;padding:12px 17px;font-size:11px;font-weight:800}.whatsapp-contact svg:last-child{margin-left:4px}.contact-form{background:var(--surface-soft);padding:26px;border:1px solid var(--border);box-shadow:0 12px 30px rgba(8,42,70,.06)}.form-heading{grid-column:1/-1}.form-heading span{font-size:10px;font-weight:800;color:var(--pack-orange);letter-spacing:1.2px}.form-heading h3{font-size:22px;color:var(--heading);margin:6px 0}.form-heading p{font-size:11px;color:var(--muted);margin:0 0 7px}.contact-form input,.contact-form textarea,.contact-form select{background:var(--surface);color:var(--text)}.contact-form select{width:100%;border:1px solid var(--border);padding:12px;font:inherit;color:var(--text)}.contact-form textarea{min-height:120px}.contact-form button{grid-column:1/-1}.form-success{grid-column:1/-1;display:flex;align-items:flex-start;gap:8px;padding:11px 13px;background:#eaf8f0;color:#167044;font-size:11px;line-height:1.5;font-weight:700}.map-card{display:grid;grid-template-columns:1fr 1.25fr;gap:28px;background:#062b50;color:#fff;padding:28px;align-items:stretch}.map-card h2{font-size:26px;margin:7px 0 10px}.map-card p{color:#cbd8e4;font-size:12px;line-height:1.7;max-width:430px}.map-placeholder{min-height:230px;background:linear-gradient(135deg,#e5ecef,#b8c9cf);color:#092a4c;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:8px}.map-placeholder svg{color:#f36b21}.map-placeholder b{font-size:16px}.map-placeholder span{font-size:11px}@media(max-width:700px){.map-card{grid-template-columns:1fr}.contact-form{padding:18px}} `}</style>
  </main>
}
