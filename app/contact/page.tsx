    ...
    <main>
      <section className="page-hero contact-hero">
        <div className="container">
          ...
          <h1>CONTACT US</h1>
          <p>
            We are here to help you. Get in touch with Pack India for your
            packaging requirements.
          </p>
        </div>
      </section>
      <section className="section">
        <div className="container contact-grid contact-enhanced">
          <div className="contact-left">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <MessageCircle /> WhatsApp Us <ArrowRight />
            </a>
          </div>
          <form className="form contact-form" onSubmit={handleSubmit}>
            ...
            {submitted && (
              <div className="form-success">
                <CheckCircle2 size={17} /> WhatsApp opened with your enquiry.
                Please send the message to complete the request.
              </div>
            )}
          </form>
        </div>
      </section>
      <section className="section map-section" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="map-card">
            <div>
              ...
              <h2>OUR LOCATION</h2>
              <p>
                Our catalogue lists the business address at Hoskote, Bengaluru -
                562114.
              </p>
              <a
                className="btn btn-orange"
                href="https://www.google.com/maps/search/?api=1&query=Sy+No.117%2F4+Dodda+Hullur+Village+Kasaba+Hobli+Hoskote+Bengaluru+562114"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <style jsx>{`
        ...
        .whatsapp-contact svg:last-child {
          margin-left: 4px;
        }
        .contact-form {
          ...
          box-shadow: 0 12px 30px rgba(8, 42, 70, 0.06);
        }
        .form-heading {
          grid-column: 1/-1;
        }
